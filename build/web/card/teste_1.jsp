...
comando = conecta.prepareStatement(
    "SELECT c.id_card, c.nome AS nome_card, t.nome AS tema, cl.nome AS classificacao, "
  + "a.chave, a.valor "
  + "FROM cards c "
  + "JOIN temas t ON c.fk_tema = t.id_tema "
  + "JOIN classificacao cl ON c.fk_classificacao = cl.id_classificacao "
  + "JOIN atributos a ON a.fk_card = c.id_card "
  + "WHERE cl.nome = '16 anos' "
  + "AND a.chave IN ('altura', 'peso', 'hobbie', 'obs', 'quant_filhos', 'cintura') "
  + "ORDER BY c.id_card, a.chave"
);
...
<%
    String ultimoCard = ""; // Armazena o nome do último card exibido
    boolean primeiro = true;

    while (resultado.next()) {
        String nomeCard = resultado.getString("nome_card");
        ...
        // Se for um novo card, fechamos o anterior (se já existia)
        if (!nomeCard.equals(ultimoCard)) {
            if (!primeiro) {
%>
                </tbody>
              </table>
...
%>
        ...
        <div class="card">
          <div class="area-img-info">
            <img class="img-principal img-principal-ativa" src="../assets/pixel_ai/1.1.png" alt="Imagem da personagem" />
            <div class="info-personagem">
              <div class="img-nome-personagem">
                <h2 class="ativo"><%= nomeCard %></h2>
                <p class="ativo"><%= tema %> - <%= classificacao %></p>
              </div>
              <table class="ativo">
                <tbody>
...
%>
        ...
        <div class="card">
          <div class="area-img-info">
              ...
              <img class="img-principal img-principal-ativa" src="../assets/pixel_ai/1.1.png"
            ...
            <div class="info-personagem">
              ...
              <div class="img-nome-personagem">
                <img class="imagem-circular ativo" src="../assets/pixel_ai/r-1.png" alt="">
                <div>
                  <h2 class="ativo">Nome Completo</h2>
                  <p class="ativo">Nascionalidade</p>
                </div>
              </div>
