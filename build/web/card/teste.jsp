...
<%
    ...
    comando = conecta.prepareStatement(
            "SELECT c.nome, t.nome AS tema, cl.nome AS classificacao "
            + "FROM cards c JOIN temas t ON c.fk_tema = t.id_tema "
            + "JOIN classificacao cl ON c.fk_classificacao = cl.id_classificacao "
            + "WHERE cl.nome = '18 anos'");
    ...
    <body>
        ...
        <main>
                    <%  
                        ...
                        String QueryNome = resultado.getString("nome");
                    %> 
                    
                    <% if (!QueryNome.equals(nome)) { %>
                     bulma dragon ball z, a 
                        ...
                        <div class="area-img-info">
                            ...
                            <div class="info-personagem">
                                ...
                                <div class="img-nome-personagem">
                                    ...
                                    <div>
                                        <h2 class="ativo"><%= resultado.getString("nome")%></h2>
